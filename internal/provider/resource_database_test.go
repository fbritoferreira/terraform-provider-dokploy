	...
	resource.Test(t, resource.TestCase{
		...
		Steps: []resource.TestStep{
			...
			// ImportState testing
			{
				...
				ImportStateVerifyIgnore: []string{"password", "username", "internal_connection_string", "external_connection_string", "project_id", "version", "app_name"}, // password and connection strings are sensitive, project_id, version, app_name sometimes not returned on import
			},
		},
	})
}
